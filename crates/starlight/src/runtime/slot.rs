...
impl Slot {
    ...
    pub fn clear(&mut self) {
        self.set(JsValue::empty(), AttrSafe::not_found());
    ...
    pub fn base(&self) -> &Option<Gc<dyn Cell>> {
        &self.base
    }

    pub fn set_1(&mut self, value: JsValue, attributes: AttrSafe, obj: Option<Gc<dyn Cell>>) {
    ...
    pub fn set_from_slot(&mut self, slot: &StoredSlot, obj: Option<Gc<dyn Cell>>) {
